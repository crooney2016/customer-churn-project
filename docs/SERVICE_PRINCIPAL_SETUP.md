...
1. Go to **Tenant settings** → **Developer settings** (or **Admin API settings**)
1. Find: **"Allow service principals to use Power BI APIs"**
1. Toggle to **Enabled**
1. Select **"Specific security groups"**
1. Add your security group: `Power BI Service Principle`
1. Click **Apply**
...
1. Toggle to **Enabled**
1. Select **"Specific security groups"**
1. Add the same security group: `Power BI Service Principle`
1. Click **Apply**

## Step 5: Grant Dataset Permissions

1. Go to **Power BI Service** → Your workspace
1. Find your dataset (e.g., "MTS V2")
...
1. Go to **Power BI Service** → Your workspace
1. Click **"..."** menu → **Workspace access**
1. Add your service principal (use Object ID)
1. Grant role: **Admin** or **Member**
1. Click **Add**
...
1. **Verify there are NO Application permissions** for Power BI Service
1. If you see any Application permissions (like `Tenant.Read.All`), **remove them**
1. You can keep Delegated permissions if needed, but they're not required for executeQueries
...
1. Verify service principal is in the security group
1. Verify NO Application permissions exist for Power BI Service
1. Verify dataset has Build permission for service principal
